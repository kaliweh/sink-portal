                        ...
                        <tbody>
                            <tr>
                                <td><div className="input-group mb-3">
                                    ...
                                    <input type="password" className="form-control" placeholder="Access Token" aria-label="" aria-describedby="basic-addon1" />
                                </div></td>
                            </tr>
                            {/* <tr>
                               <td> <input type='password' className='form-control connectionStrings' /></td>
                            </tr> */}
                        </tbody>
                    </table>
                </div>
